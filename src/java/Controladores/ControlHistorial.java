...
public class ControlHistorial {
    ...
    public Boolean Elminar(Historial h){
    ...
    public ArrayList<Historial> GetAllOrderByHabitacion(){
        ...
        try{
            ...
            p = con.prepareStatement("select * from historial order by id_habitacion");
            rs = p.executeQuery();
            while ( rs.next() ) {                
    ...
    public ArrayList<Historial> GetAllOrderByDiaSemana(){
        ...
        try{
            ...
            p = con.prepareStatement("select * from historial order by dia_semana");
            rs = p.executeQuery();
            while ( rs.next() ) {                
    ...
    public ArrayList<Historial> GetAllOrderByFecha(){
        ...
        try{
            ...
            p = con.prepareStatement("select * from historial order by fecha");
            rs = p.executeQuery();
            while ( rs.next() ) {                
